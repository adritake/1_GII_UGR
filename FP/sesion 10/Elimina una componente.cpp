/* Programa para eliminar una componente de una serie de caracteres
...
public:
	...
	void Elimina(int posicion){
		...
		if(posicion<=total_utilizados){
			...
			for(i=posicion-1; i <=total_utilizados; i++){
...
int main () {
	...
	cout<<"\nIntroduce la posicion que quieres eliminar: ";
	cin>>posicion_a_eliminar;
	
	Secuencia.Elimina(posicion_a_eliminar);
